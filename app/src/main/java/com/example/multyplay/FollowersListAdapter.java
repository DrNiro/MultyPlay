...
public class FollowersListAdapter extends RecyclerView.Adapter<FollowersListAdapter.ViewHolder> implements Filterable {
    ...
    FollowersListAdapter(Context context, List<Account> data) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.followItem_TXT_action.setText("remove");
    }
    ...
    private Filter followersFilter = new Filter() {
        @Override
